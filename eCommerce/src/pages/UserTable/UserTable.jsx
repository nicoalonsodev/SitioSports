...
const UserTable = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        dispatch(setBackendUsers(users));
      } catch (error) {
  ...
  const users = useSelector((state) => state.orebiReducer.users.users);
  const count = useSelector((state) => state.orebiReducer.users.count);
