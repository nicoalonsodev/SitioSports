    ...
    <div className="max-w-container mx-auto px-4">
      ...
      <div className="px-72 py-4 flex flex-wrap">
        <p className="text-balance text-left">
          TE PRESENTAMOS NUESTRO CATÁLOGO POR ENCARGO. TE TRAEMOS EL MODELO Y TALLE QUE NOS PIDAS! UNA VEZ QUE TENGAS TU MODELO HACE <a className="text-pink-500 hover:underline uppercase" href="https://wa.me/+5493813624693" target="_blank">click par contactarnos por whatsapp</a>
        </p>
        <ul className="list-disc pl-5 mt-4 text-left">
          ...
          <li>Elegir de nuestro catálogo (Si no encuentras tu botín, <a className="text-pink-500 hover:underline" href="https://wa.me/+5493813624693" target="_blank">contáctanos haciendo click aqui</a>)</li>
          <li>Talles del 5US al 12 US</li>
          <li>Precio 140 USD, se paga el 50% para hacer el encargo y el 50% cuando llegan</li>
        </ul>
